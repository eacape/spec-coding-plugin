...
internal object RequirementsSectionAiSupport {
    ...
    fun resolvePreferredRealProviderId(
        ...
        llmRouter: LlmRouter = LlmRouter.getInstance(),
        settingsProvider: () -> SpecCodingSettingsState = { SpecCodingSettingsState.getInstance() },
    ): String? {
        ...
        val defaultProvider = settingsProvider()
            .defaultProvider
            .trim()
            .takeIf(String::isNotBlank)
